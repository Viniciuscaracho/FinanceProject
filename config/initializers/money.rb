...
Rails.configuration.to_prepare do
  MoneyRails.configure do |config|
    ...
    #
    config.default_currency = -> { Current.default_currency || :brl }

    # Set default bank object
    #
    # Example:
    config.default_bank = lambda {
      oxr = Money::Bank::OpenExchangeRatesBank.new(ExchangeRate.new)
      oxr.app_id = Rails.application.credentials.dig(:open_exchange_rates, :app_id)
      oxr
    }
