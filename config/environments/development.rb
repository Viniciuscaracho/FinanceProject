...
Rails.application.configure do
  ...
  # Cloudflare Tunnel empilha proxies que causam IpSpoofAttackError no remote_ip.
  # Mesmo fix do staging.rb — aplicado aqui porque o backend roda em development.
  if ActiveModel::Type::Boolean.new.cast(ENV.fetch('TRUST_PROXY_HEADERS', 'true'))
    ...
    config.action_dispatch.trusted_proxies =
      ...
      cloudflare_ranges.map { |proxy| IPAddr.new(proxy) }
  end
end
