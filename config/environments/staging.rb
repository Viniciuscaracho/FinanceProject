...
Rails.application.configure do
  ...
  # um 500 em TODA requisição (basta a linha de log "Started GET ... for <ip>",
  # emitida no log_level :info, forçar o cálculo do remote_ip). Confiar na cadeia
  # de proxy resolve os 500 e faz o remote_ip resolver para o IP real do cliente.
  #
