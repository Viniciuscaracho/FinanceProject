...
#
# Nutricionistas de demonstração com endereços completos e coordenadas reais de SP
...
puts "\n#{'='*70}"
puts '🥦 CRIANDO NUTRICIONISTAS COM ENDEREÇOS E COORDENADAS'
puts "#{'='*70}\n"
