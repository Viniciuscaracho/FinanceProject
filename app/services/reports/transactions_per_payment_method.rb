...
module Reports
  class TransactionsPerPaymentMethod < ApplicationService
    ...
    def call
      ...
      query = query.where(payment_method_cd: context.payment_method_cd)
      ...
      query.each do |transaction|
        name = transaction.name.presence || I18n.t('shared.not_informed')
