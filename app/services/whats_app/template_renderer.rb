...
module WhatsApp
  class TemplateRenderer
    TEMPLATES = {
      appointment_confirmation: "Olá %<patient>s! Seu agendamento com %<professional>s está confirmado para %<datetime>s. 📅",
    ...
    def self.build_vars(event, resource, contact)
      ...
      when :appointment_confirmation
        base.merge(datetime: format_datetime(resource.start_time))
