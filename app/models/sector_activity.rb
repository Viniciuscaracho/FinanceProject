...
#
class SectorActivity < Segment
  belongs_to :business_sector,  class_name: 'BusinessSector',   inverse_of: :sector_activities, foreign_key: :parent_id
  has_many   :category_presets, inverse_of: :sector_activity,   foreign_key: :parent_id, dependent: :restrict_with_error
  has_many   :people,           inverse_of: :sector_activity,   dependent: :nullify
end
