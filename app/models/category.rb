...
class Category < Domain
  ...
  as_enum :transaction_type, Transaction::TRANSACTION_TYPES.except(:transfer)

  after_update_commit do
    publish 'category_updated', record: self
  end

  after_create_commit do
    publish 'category_created', record: self
  end

  after_destroy_commit do
    publish 'category_destroyed', record: self
  end
