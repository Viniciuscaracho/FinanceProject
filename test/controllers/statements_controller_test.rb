...
class StatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post statements_url, params: { statement: { account_id: @statement.account_id, bank_account_id: @statement.bank_account_id, type_cd: @statement.type_cd } }
  #   end
  #
  ...
  #   patch statement_url(@statement), params: { statement: { account_id: @statement.account_id, bank_account_id: @statement.bank_account_id, type_cd: @statement.type_cd } }
